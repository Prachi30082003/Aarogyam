    ...
    dashData && (
      <div className="m-5">
        <div className="flex flex-wrap gap-3">
          <div className="flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 tarnsition-all">
            ...
            {dashData.latestAppointments.map((item, index) => (
              ...
              >
                ...
                {item.cancelled ? (
                  ...
                  <p className="text-green-500 text-xs font-medium" lass>
                    Completed
                  </p>
                ) : (
                  <img
