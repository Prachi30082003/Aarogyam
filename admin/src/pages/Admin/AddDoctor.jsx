...
const AddDoctor = () => {
  ...
  //make api call using backendUrl

  const onSubmitHandler = async(event)=>{
    event.preventDefault()
    //call api to add doctor to the database
    ...
    try {
      ...
      formData.append("image" , docImg) // use same name as specified in multer
      ...
      //aToken will be converted to lowercase thus no issue cause in code of backend I wrote atoken
        ...
        <div className="flex flex-col lg:flex-row items-start gap-10 text-gray-600">
          <div className="w-full lg:flex-1 flex flex-col gap-4">
            <div className="flex-1 flex flex-col gap-1">
              <p> Doctor Name </p>
              <input onChange={(e)=>setName(e.target.value)} value={name} className="border border-gray-300 rounded px-3 py-2"
                type="text"
                placeholder="Name"
                required
              />
