  ...
  return profileData && (
    <div>
      ...
      <div className='flex flex-col gap-4 m-5'>
        ...
        <div>
          <img className='bg-primary/80  w-full h-[200px] object-contain sm:max-w-64 rounded-lg' src={profileData.image} alt="" />
          </div>
          ...
          <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
            ...
            <div className='flex items-center gap-2 mt-1 text-gray-600'>
              ...
              <button className='py-0.5 border border-gray-200 text-xs rounded-full'>{profileData.experience}</button>
            </div>
