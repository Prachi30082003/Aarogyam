...
const RelatedDoctors = ({docId , speciality}) => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
      ...
      <p className='sm:w-1/3 text-center text-sm'>Simply browse through out extensive list of doctors</p>
      <div className='w-full grid grid-cols-(--my-grid-cols) gap-4 pt-5 gap-y-6 px-3 sm:px-0'>
